...
# CatGen accepts two distribution vectors, a desired value
# of Theil's uncertainty coefficient, and a natural number N

# it returns a simulated sample of size N from a categorical
# random vector having the desired marginal distributions
# and value of U between margins
